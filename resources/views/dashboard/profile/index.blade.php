...
<x-body>
                                        ...
                                        <form action="/dashboard/profile/{{ $user->username }}" method="post"
                                            ...
                                            <div class="relative mb-5">
                                                <select id="role" name="role"
                                                    class="peer block border-b-2 p-2 border-gray-300 focus:border-primary focus:outline-none  w-full appearance-none"
                                                    disabled>
                                                    <option value="writer" class=""
                                                        {{ old('role', $user->role) == 'writer' ? 'selected' : '' }}>
                                                        writer
                                                    </option>
                                                    <option value="writer" class=""
                                            ...
                                            <div class="p-4">
                                                <a href="profile/{{ $user->username }}/edit"
                                                    class="bg-primary p-1 rounded-lg h-10 w-full flex items-center justify-center group hover:bg-white hover:border-2 hover:border-primary text-white font-bold hover:text-primary transition duration-200">
                                                    Edit Profile
                                                </a>
                                            </div>
    ...
    <script>
        ...
        function previewImage() {
            const image = document.querySelector('#pprofile');
