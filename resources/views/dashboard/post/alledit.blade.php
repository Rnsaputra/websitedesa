...
<x-body>
            ...
            <div class="flex flex-1">
                ...
                <div class="  w-full static flex flex-col gap-4     ">
                    ...
                    <div class="max-w-5xl w-full bg-white shadow-lg rounded-lg mx-auto p-4 lg:w-4/6 mt-20">
                        ...
                        <form action="/dashboard/{{ auth()->user()->role }}/posts/{{ $post->slug }}" method="post" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="relative mb-5">
                                ...
                                <input type="hidden" id="slug" name="slug" required class="hidden"
                            ...
                            <div class="relative mb-5">
                                <select id="category_id" name="category_id"
                                    class="w-full peer block  border-b-2 p-2 border-gray-300 focus:border-primary focus:outline-none "
                                    required>
                            ...
                            <div class="mb-5">
                                ...
                                @error('body')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                                <input id="body" name="body" class="hidden"
                            ...
                            <div class="relative mb-5">
                                ...
                                @if ($post->image)
                                    <img id="imagePreview" src="{{ asset('storage/' . $post->image) }}"
                                        class="mt-2 rounded-lg aspect-3/2 align-self-center w-3/4 mx-auto  object-cover  md:h-80 lg:h-96"
                                        alt="Image Preview">
                                @else
                                    <img id="imagePreview"
    ...
    <script>
        ...
        const oldBody = `{!! old('body', $post->body) !!}`;
        if (oldBody) {
