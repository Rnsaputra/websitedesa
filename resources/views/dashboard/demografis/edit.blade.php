                            ...
                            <div class="w-full pb-3  rounded-lg md:col-span-2 drop-shadow-md">
                                ...
                                <div class="flex justify-center items-center min-h-screen">
                                    <main id="form-registration" class="bg-white w-100 shadow-xl rounded-lg">
                                        {{-- heading --}}
                                        <div class="p-4">
                                            <h1 class="text-center font-bold text-2xl">Ubah Data Penduduk</h1>
                                        </div>


                                        {{-- body --}}
                                        <form action="/dashboard/demografis/data/{{ $penduduk->namadusun }}" method="post"
                                            class="p-4 flex flex-col gap-3">
                                            @method('put')
                                            @csrf
                                            <div class="relative mb-2">
                                                <input type="text" id="namadusun" name="namadusun" placeholder=" "
                                                    value="{{ old('namadusun', $penduduk->namadusun) }}"
                                            ...
                                            <div class="relative mb-2">
                                                <input type="number" id="laki" name="laki" placeholder=" "
                                                    value="{{ old('laki',$penduduk->laki) }}"
                                                    class="peer block w-full border-b-2 p-2 border-gray-300 focus:border-primary focus:outline-none"
                                            ...
                                            <div class="relative mb-2">
                                                <input type="number" id="perempuan" name="perempuan" placeholder=" "
                                                    value="{{ old('perempuan',$penduduk->perempuan) }}"
                                                    class="peer block w-full border-b-2 p-2 border-gray-300 focus:border-primary focus:outline-none"
                                            ...
                                            <div class="relative mb-2">
                                                <input type="number" id="kepala" name="kepala" placeholder=" "
                                                    value="{{ old('kepala', $penduduk->kepala) }}"
                                                    class="peer block w-full border-b-2 p-2 border-gray-300 focus:border-primary focus:outline-none"
                                                    required step="0.01" min="0" />
                                                <label for="kepala"
                                                    class="cursor-text absolute left-0 -top-3.5 transform scale-75 origin-[0_0] text-gray-500 transition-all duration-200 peer-placeholder-shown:top-2 peer-placeholder-shown:scale-100 peer-focus:-top-3.5 peer-focus:scale-75">
