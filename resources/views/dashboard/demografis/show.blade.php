                            ...
                            <table class="min-w-full bg-white border border-gray-200">
                                <thead>
                                    <tr class="bg-rose-500 text-white">
                                        <th class="py-2 px-4 border-b text-left border-r border-gray-200">Dusun</th>
                                        <th class="py-2 px-4 border-b text-left border-r border-gray-200">Laki Laki</th>
                                        <th class="py-2 px-4 border-b text-left border-r border-gray-200">Perempuan</th>
                                        <th class="py-2 px-4 border-b text-left border-r border-gray-200">Kepala
                                            Keluarga</th>
                                ...
                                <tbody>
                                    @foreach ($penduduk as $data)
                                        <tr class="{{ $loop->even ? 'bg-rose-100' : 'bg-white' }}">
                                            <td class="py-2 px-4 border-r border-gray-200">{{ $data->namadusun }}</td>
                                            <td class="py-2 px-4 border-r border-gray-200">
                                                {{ number_format($data->laki, 0, ',', '.') }}</td>
                                            <td class="py-2 px-4 border-r border-gray-200">
                                                {{ number_format($data->perempuan, 0, ',', '.') }}</td>
                                            <td class="py-2 px-4 border-r border-gray-200">
                                                {{ number_format($data->kepala, 0, ',', '.') }}</td>
                                            <td class="py-2 px-4 border-r border-gray-200">
                                                {{ number_format($data->total_penduduk, 0, ',', '.') }}</td>
                                            <td class="py-2 px-4 border-r border-gray-200">
                                            ...
                                            <td class="py-2 px-4 border-r border-gray-200 flex gap-2">
                                                ...
                                                <a href="data/{{ $data->namadusun }}/edit" class="block">
                                                    <div
                                                ...
                                                <form action="data/{{ $data->namadusun }}" method="post">
                                                    @method('delete')
                                                    @csrf
