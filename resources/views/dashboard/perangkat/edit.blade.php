                            ...
                            <div class="w-full pb-3  rounded-lg md:col-span-2 drop-shadow-md">
                                ...
                                <div class="flex justify-center items-center min-h-screen">
                                    <main id="form-registration" class="bg-white w-100 shadow-xl rounded-lg">
                                        {{-- heading --}}
                                        <div class="p-4">
                                            <h1 class="text-center font-bold text-2xl">Edit Data {{ $user->name }}</h1>
                                        </div>


                                        {{-- body --}}
                                        <form action="/dashboard/admin/perangkat/{{ $user->name }}" method="post" class="p-4 flex flex-col gap-3"
                                            ...
                                            <div class="p-4">
                                                <button type="submit" name="Daftar"
                                                    class="w-full bg-primary rounded-lg h-10 cursor-pointer hover:bg-primary/70 font-bold text-white">Update</button>
                                            </div>
                                        </form>
