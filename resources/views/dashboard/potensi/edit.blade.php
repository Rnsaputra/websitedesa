                            ...
                            <div class="w-full pb-3  rounded-lg md:col-span-2 drop-shadow-md">
                                ...
                                <div class="flex justify-center items-center min-h-screen">
                                    <main id="form-registration" class="bg-white w-100 shadow-xl rounded-lg">
                                        {{-- heading --}}
                                        <div class="p-4">
                                            <h1 class="text-center font-bold text-2xl">Edit Kategori Potensi</h1>
                                        </div>


                                        {{-- body --}}
                                        <form action=" /dashboard/admin/potensi/categories/{{ $potensiCategory->name }}" method="post"
                                            class="p-4 flex flex-col gap-3" enctype="multipart/form-data">
                                            @method('put')
                                            @csrf
                                            <div class="relative mb-2">
                                                <input type="text" id="name" name="name" placeholder=" "
                                                    value="{{ old('name', $potensiCategory->name) }}"
                                            ...
                                            <div class="relative mb-2">
                                                <input type="text" id="description" name="description"
                                                    placeholder=" " value="{{ old('description', $potensiCategory->description) }}"
                                                    class="peer block w-full border-b-2 p-2 border-gray-300 focus:border-primary focus:outline-none "
                                                    required />
                                            ...
                                            <div class="p-4">
                                                <button type="submit"
                                                    class="w-full bg-primary rounded-lg h-10 cursor-pointer hover:bg-primary/70 font-bold text-white">Edit</button>
                                            </div>
                                        </form>
